  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="mt-8 flex justify-center">
        {currentPage > 1 && (
          <button
            className="mr-2 bg-purple-100 text-purple-600 px-4 py-2 rounded-lg hover:bg-purple-200 transition duration-300"
        ...
        {currentPage < totalPages && (
          <button
            className="bg-purple-100 text-purple-600 px-4 py-2 rounded-lg hover:bg-purple-200 transition duration-300"
            onClick={() => handlePageChange(currentPage + 1)}
          >
            Next
          </button>
