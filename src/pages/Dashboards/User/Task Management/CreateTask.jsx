...
import { Calendar, Clock, Paperclip, User, Flag, CheckSquare } from 'lucide-react';
...
const CreateTask = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${import.meta.env.VITE_REACT_APP_API}/api/v1/tasks/create`, formData);
      if (response.data.success) {
        Swal.fire({
            title: 'Task Created',
      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="md:flex">
          <div className="p-8 w-full">
            <div className="uppercase tracking-wide text-sm text-purple-600 font-semibold mb-1">Create New Task</div>
                ...
                <div className="mt-1 flex items-center">
                  ...
                  >
                    <span className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                      ...
                      Upload Image  <span className="text-xm text-gray-400 font-medium">&nbsp;(jpg, jpeg, png only)</span>
                    </span>
                  </label>
                </div>
                {imagePreview && (
