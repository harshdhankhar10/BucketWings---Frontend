...
const UpdateNote = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    setLoading(true);
   try {
    const response = await axios.put(`${import.meta.env.VITE_REACT_APP_API}/api/v1/notes/update/${id}`, {
      title,
      content,
      tags
    })
  ...
  return (
    <div className=" min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-white shadow-lg rounded-lg p-8">
        <h1 className="text-3xl font-bold text-purple-700 mb-6">Update Note</h1>
