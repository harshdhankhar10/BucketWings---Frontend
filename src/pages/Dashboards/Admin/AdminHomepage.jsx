...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: FiUsers,
      subMenus: [
        { label: 'View Users', link: '/users' },
        { label: 'Activity Logs', link: '/activity-logs' },
        { label: 'Feedback Reports', link: '/feedback-reports' }
      ]
    },
    {
  ...
  return (
    <div className="max-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex ">
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      >
        <div className="h-full flex flex-col ">
          <div className="p-6 flex items-center gap-3 ">
            ...
            <span className='ml-4 mt-1 lg:hidden' onClick={() => setIsMobileMenuOpen(false)}>
          ...
          <nav className="flex-1 px-4 space-y-3 overflow-y-auto scrollbar-hide">
            <button className="bg-purple-100 text-gray-600 w-full flex items-center rounded-xl transition-all duration-200">
              <Link to="/dashboard" className={`w-full flex items-center p-3 rounded-xl transition-all duration-200
                ${location.pathname === '/dashboard'
                  ? 'bg-gradient-to-r from-indigo-500/20 to-purple-500/20 text-indigo-700'
                  : 'hover:bg-gray-100 text-gray-600'}`}
              >
                <FiHome className={`text-xl ${location.pathname === '/dashboard' ? 'text-indigo-600' : 'text-gray-500'}`} />
            ...
            <button className=" text-gray-600 w-full bg-purple-100 p-3 flex items-center rounded-xl transition-all duration-200 flex gap-6">
          ...
          <div className="flex items-center justify-between px-4 py-4 ">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
               ...
               <span className="hidden lg:block text-md font-medium text-gray-700">{auth.fullName}</span>
