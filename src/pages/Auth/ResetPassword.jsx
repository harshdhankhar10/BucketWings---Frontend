...
const ResetPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reset Password | BucketWings</title>
      </Helmet>
      <NavBar />
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-blue-50 to-purple-100 py-12 px-4 sm:px-6 lg:px-8">
        <motion.div
