...
<footer className="bg-white">
  <div className="mx-auto  px-4 py-16 sm:px-6 ">
    <div
      className="flex flex-col items-center gap-4 rounded-lg bg-indigo-600 p-6 shadow-lg sm:flex-row sm:justify-between"
    >
      <strong className="text-xl text-white sm:text-xl"> Signup to Newsletter </strong>

        <form className="flex gap-4 sm:gap-6 sm:justify-end">
            <input type="email" placeholder="Enter your email" className="px-4 py-2 text-sm w-96 text-gray-900 placeholder-gray-500 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-indigo-600 focus:border-indigo-600" />
            <button type="submit" className="px-6 py-2 text-sm text-white bg-indigo-500 rounded-lg hover:bg-indigo-400 focus:outline-none focus:ring focus:ring-indigo-600 focus:border-indigo-600"> Subscribe </button>
        </form>
    </div>

    <div className="mt-16 px-2 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="mt-16">
      ...
      <div className="mt-16 sm:flex sm:items-center sm:justify-between">
        <h1 className="text-center text-xl text-gray-500 sm:text-left">
        BucketWings
        </h1>
